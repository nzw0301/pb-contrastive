...
def train(
    ...
    :param optimizer: PyTorch's initializer
    :param epoch: The number of epochs
    :param contrastive_loss: the instance of ContrastiveLoss class
    :param batch2input_shape_pos:
    :param batch2input_shape_neg:
    :param output2emb_shape_pos:
    :param output2emb_shape_neg:
    :param logger: logger
...
def main():
    ...
    (batch2input_shape_pos, batch2input_shape_neg, output2emb_shape_pos,
     output2emb_shape_neg) = get_shape_for_contrastive_learning(args.batch_size, args.block_size, args.neg_size,
                                                                args.dim_h)
